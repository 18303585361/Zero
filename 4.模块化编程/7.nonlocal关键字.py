...
__name__  ==>   当前脚本如果作为主程序，那么值是 __main__；
                如果是当作一个模块，在另外一个脚本中引用去使用，那么值就是当前文件的名字
...
｛
    ...
    '__doc__': '\n在内函数中如果想使用',
    '__package__': None, 
    '__loader__': <_frozen_importlib_external.SourceFileLoader object at 0x0000000001D10880>,
    '__spec__': None, 
    '__annotations__': {},
    '__builtins__': <module 'builtins' (built-in)>,
    '__file__': 'G:/Code/4.模块化编程/7.nonlocal关键字.py',
    '__cached__': None,
    'outer': <function outer at 0x00000000026C1790>
｝
'''
